        ...
        <header class="header df">
            <div class="header__body df">
                ...
                <div class="header__logo header__logo--path">
                    ...
                    ->
                    <a href="<?php the_field('menu_link_3')?>" class="header__link" data-lang="eng"><?php the_field('menu_eng_3'); ?></a>
                    <a href="<?php the_field('menu_link_3')?>" class="header__link" data-lang="ua"><?php the_field('menu_ua_3'); ?></a>
